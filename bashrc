...
alias la="ls -a"
alias lal="ls -alh"
alias vim=nvim # open neovim with vim
alias ff=fastfetch # open fastfetch
alias lg=lazygit # lazygit
alias lk=asciiquarium # use asciiquarium to lock screen
alias c=clear # clear screen in terminal
alias e=exit # exit terminal
alias o=xdg-open #open with desktop utils
# this make you stay in the directory that operating in ranger when you quit from ranger
alias ra='ranger --choosedir=$HOME/.rangerdir; LASTDIR=`cat $HOME/.rangerdir`; cd "$LASTDIR"'
alias v2='sudo v2raya'
